...
const (
	...
	// BeaconRegisteredEvent - First connection from a new bacon.
	BeaconRegisteredEvent = "bacon-registered"

	// BeaconTaskResult - Bacon task completed with a result.
	BeaconTaskResultEvent = "bacon-taskresult"
